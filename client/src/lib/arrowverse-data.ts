...
export const arrowverseData: Record<number, Episode[]> = {
  2012: [
    { id: 'arrow-s01e01', title: 'Pilot', titlePt: 'Piloto', series: 'Arrow', season: 1, episode: 1, airDate: '2012-10-10', year: 2012, isCrossover: false, summary: 'Oliver Queen retorna a Starling City após cinco anos náufrago em uma ilha. Ele se torna o vigilante conhecido como Capuz para combater a corrupção e o crime em sua cidade.', runtime: 42, rating: 8.1, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e02', title: 'Honor Thy Father', titlePt: 'Honra Teu Pai', series: 'Arrow', season: 1, episode: 2, airDate: '2012-10-17', year: 2012, isCrossover: false, summary: 'Oliver continua sua missão de limpar a cidade visando o empresário corrupto Adam Hunt. Enquanto isso, ele tenta se reconectar com sua família.', runtime: 42, rating: 7.9, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e03', title: 'Lone Gunmen', titlePt: 'Atirador Solitário', series: 'Arrow', season: 1, episode: 3, airDate: '2012-10-24', year: 2012, isCrossover: false, summary: 'Oliver enfrenta um novo assassino que usa armas de fogo, forçando-o a repensar seus métodos de combate ao crime.', runtime: 42, rating: 7.8, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e04', title: 'An Innocent Man', titlePt: 'Um Homem Inocente', series: 'Arrow', season: 1, episode: 4, airDate: '2012-10-31', year: 2012, isCrossover: false, summary: 'Oliver tenta salvar um homem inocente da prisão enquanto lida com as consequências de suas ações como vigilante.', runtime: 42, rating: 8.0, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e05', title: 'Damaged', titlePt: 'Danificado', series: 'Arrow', season: 1, episode: 5, airDate: '2012-11-07', year: 2012, isCrossover: false, summary: 'Oliver é preso como suspeito de ser o Capuz, forçando-o a encontrar uma maneira de provar sua inocência.', runtime: 42, rating: 8.2, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e06', title: 'Legacies', titlePt: 'Legados', series: 'Arrow', season: 1, episode: 6, airDate: '2012-11-14', year: 2012, isCrossover: false, summary: 'Oliver enfrenta uma família de ladrões de banco enquanto explora seu próprio legado familiar.', runtime: 42, rating: 7.7, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e07', title: 'Muse of Fire', titlePt: 'Musa do Fogo', series: 'Arrow', season: 1, episode: 7, airDate: '2012-11-28', year: 2012, isCrossover: false, summary: 'Uma nova vigilante feminina aparece em Starling City, causando tensão entre Oliver e sua missão.', runtime: 42, rating: 7.9, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e08', title: 'Vendetta', titlePt: 'Vingança', series: 'Arrow', season: 1, episode: 8, airDate: '2012-12-05', year: 2012, isCrossover: false, summary: 'Oliver continua lidando com a vigilante Huntress enquanto enfrenta novos desafios em sua guerra contra o crime.', runtime: 42, rating: 8.0, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e09', title: 'Year\'s End', titlePt: 'Fim de Ano', series: 'Arrow', season: 1, episode: 9, airDate: '2012-12-12', year: 2012, isCrossover: false, summary: 'Um arqueiro sombrio aparece em Starling City, desafiando Oliver e forçando-o a questionar seus métodos.', runtime: 42, rating: 8.3, streaming: ['Prime Video', 'Netflix'] }
  ],
  2013: [
    { id: 'arrow-s01e10', title: 'Burned', titlePt: 'Queimado', series: 'Arrow', season: 1, episode: 10, airDate: '2013-01-16', year: 2013, isCrossover: false, summary: 'Oliver ajuda um bombeiro que está sendo perseguido por um piromaníaco vingativo.', runtime: 42, rating: 7.8, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e11', title: 'Trust But Verify', titlePt: 'Confie Mas Verifique', series: 'Arrow', season: 1, episode: 11, airDate: '2013-01-23', year: 2013, isCrossover: false, summary: 'Oliver investiga o pai de Diggle quando suspeita que ele está envolvido em atividades criminosas.', runtime: 42, rating: 8.1, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s01e12', title: 'Vertigo', titlePt: 'Vertigem', series: 'Arrow', season: 1, episode: 12, airDate: '2013-01-30', year: 2013, isCrossover: false, summary: 'Oliver enfrenta um traficante de drogas conhecido como Count Vertigo.', runtime: 42, rating: 8.0, streaming: ['Prime Video', 'Netflix'] },
    ...
    { id: 'arrow-s02e08', title: 'The Scientist', titlePt: 'O Cientista', series: 'Arrow', season: 2, episode: 8, airDate: '2013-12-04', year: 2013, isCrossover: false, summary: 'Barry Allen chega a Starling City para investigar um caso impossível, preparando o terreno para The Flash.', runtime: 42, rating: 8.5, streaming: ['Prime Video', 'Netflix'] },
    { id: 'arrow-s02e09', title: 'Three Ghosts', titlePt: 'Três Fantasmas', series: 'Arrow', season: 2, episode: 9, airDate: '2013-12-11', year: 2013, isCrossover: false, summary: 'Oliver enfrenta três inimigos de seu passado enquaanto Barry Allen o ajuda a resolver um mistério científico.', runtime: 42, rating: 8.6, streaming: ['Prime Video', 'Netflix'] }
  ],
  2014: [
    ...
    { id: 'flash-s01e01', title: 'Pilot', titlePt: 'Piloto', series: 'The Flash', season: 1, episode: 1, airDate: '2014-10-07', year: 2014, isCrossover: false, summary: 'Barry Allen desperta de um coma após ser atingido por um raio durante a explosão do acelerador de partículas. Ele descobre que tem super velocidade e inicia sua jornada como The Flash.', runtime: 42, rating: 8.7, streaming: ['Prime Video', 'Netflix', 'HBO Max'] },
    ...
    { id: 'flash-s01e02', title: 'Fastest Man Alive', titlePt: 'O Homem Mais Rápido Vivo', series: 'The Flash', season: 1, episode: 2, airDate: '2014-10-14', year: 2014, isCrossover: false, summary: 'Barry aprende a controlar melhor seus poderes enquanto enfrenta seu primeiro meta-humano.', runtime: 42, rating: 8.3, streaming: ['Prime Video', 'Netflix', 'HBO Max'] },
    ...
    { id: 'flash-s01e03', title: 'Things You Can\'t Outrun', titlePt: 'Coisas das Quais Você Não Pode Fugir', series: 'The Flash', season: 1, episode: 3, airDate: '2014-10-21', year: 2014, isCrossover: false, summary: 'Barry enfrenta um meta-humano que pode se transformar em gás venenoso.', runtime: 42, rating: 8.1, streaming: ['Prime Video', 'Netflix', 'HBO Max'] },
    ...
    { id: 'flash-s01e04', title: 'Going Rogue', titlePt: 'Tornando-se Vilão', series: 'The Flash', season: 1, episode: 4, airDate: '2014-10-28', year: 2014, isCrossover: false, summary: 'Barry enfrenta Leonard Snart, que se torna Captain Cold com uma arma que pode congelar qualquer coisa.', runtime: 42, rating: 8.2, streaming: ['Prime Video', 'Netflix', 'HBO Max'] },
